...
final class ImageSlideViewController: UIViewController {
    ...
    private func rxSetView() {
        Observable.from(optional: images)
            .bind(to: collectionView.rx.items(cellIdentifier: ImageCollectionViewCell.reuseCellName,
                                              cellType: ImageCollectionViewCell.self)) { _, data, cell in
